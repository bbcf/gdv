...
public class SQLiteProcessor implements Runnable{
	 ...
	 * @param admin 
	 */
	public SQLiteProcessor(int trackId, File file, String tmpDir, String extension, Users user, String speciesId, boolean sendMail, boolean admin) {
		this.file = file;
		this.user = user;
	...
	public void run() {
		...
		String speciesName = SpeciesControl.getSpeciesNameBySpeciesId(speciesId);
		SQLiteAccess.writeNewJobTransform(file.getAbsolutePath(), trackId, tmpDir, extension, mail, speciesName, user.getId());
	}
