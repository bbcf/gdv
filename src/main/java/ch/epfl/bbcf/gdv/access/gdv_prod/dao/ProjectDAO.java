...
public class ProjectDAO extends DAO<Project>{
	...
	private final static String[] fields = {"id","description","seq_id"};
...
//	public Project getViewFromInternId(int defaultViewId) {
//		Project view = null;
//		if(this.databaseConnected()){
//			this.startQuery();
//			try {
//				String query = "select t1.* from views as t1 " +
//				"inner join internViewToView as t2 on t1.id = t2.view_id " +
...
//	public boolean deleteLinks(int viewId) {
//		if(this.databaseConnected()){
//			this.startQuery();
//			try {
//				String query = "delete from viewtojbtracks "+
//				" where viewId = ? ;";
//				PreparedStatement statement = this.prepareStatement(query,
//						ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_READ_ONLY);
...
//	}
	...
	private Project getProject(ResultSet resultSet) {
		...
		try {
			project.setDescription(resultSet.getString(fields[1]));
		} catch (SQLException e) {
			logger.error(e);
		}
		try {
			project.setSequenceId(resultSet.getInt(fields[2]));
		} catch (SQLException e) {
			logger.error(e);
		}
		return project;
...
//	public boolean linkToViewTrack(Integer viewId, List<Integer> idList) {
//		if(this.databaseConnected()){
//			this.startQuery();
//			for(Integer jbId : idList){
//				try {
//					String query = "insert into internViewToTracks values ( ? , ? );";
//					PreparedStatement statement = this.prepareStatement(query,
//							ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_READ_ONLY);
//					statement.setInt(1, viewId);
...
//	public List<Integer> getViewTrackIdsFromViewId(int viewId) {
//		List<Integer> ids = new ArrayList<Integer>();
//		if(this.databaseConnected()){
//			this.startQuery();
//			try {
//				String query = "select id from viewtotracks where view_id = ? ;";
//				PreparedStatement statement = this.prepareStatement(query,
//						ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_READ_ONLY);
//				statement.setInt(1, viewId);
//				ResultSet resultSet = this.executeQuery(statement);
//				while (resultSet.next()) {
//					ids.add(resultSet.getInt("viewtracks_id"));
//				}
//				this.endQuery(true);
//			} catch (SQLException e) {
//				logger.error(e);
...
//	public boolean isCreated(ViewWrapper v) {
//		if(this.databaseConnected()){
//			this.startQuery();
//			try {
//				String query = "select 1 from views where id = ? and status = 3 ;";
//				PreparedStatement statement = this.prepareStatement(query,
//						ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_READ_ONLY);
//				statement.setInt(1, v.getViewId());
//				ResultSet resultSet = this.executeQuery(statement);
//				if (resultSet.first()) {
//					this.endQuery(true);
//					return true;
...
//	public void updateViewStatus(int viewId, int status) {
//		if(this.databaseConnected()){
//			this.startQuery();
//			try {
//				String query = "UPDATE views set status = ? where id = ?  ; ";
//				PreparedStatement statement = this.prepareStatement(query,
//						ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_READ_ONLY);
...
//	public int createDefaultInterViewFromUser(int id) {
//		if(this.databaseConnected()){
//			this.startQuery();
//			try {
//				String query = "insert into internViews values (default,true) ;";
//				PreparedStatement statement = this.prepareStatement(query,
//						ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_READ_ONLY);
//				this.executeUpdate(statement);
//				//get the default value
//				int viewId = -1;
//				query = "select currval('internViews_id_seq') ; ";
//				statement = this.prepareStatement(query,
//						ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_READ_ONLY); 	                               
//				ResultSet resultSet = this.executeQuery(statement);
//				if(resultSet.first()){
//					viewId = resultSet.getInt(1);
//				}
//				this.endQuery(true);
//				return viewId;
//			} catch (SQLException e) {
...
//	}
//
//	public int getDefaultInternViewFromUserAndSequenceId(int userId, int sequenceId) {
//		if(this.databaseConnected()){
//			this.startQuery();
//			try {
//				String query = "select t1.* from internViews as t1 " +
//				"inner join userToInternView as t2 on t2.internview_id = t1.id " +
//				"inner join internviewtoview as t3 on t1.id = t3.internview_id " +
//				"inner join views as t4 on t3.view_id = t4.id " +
//				"where t2.user_id = ? and t1.isdefault = true and t4.seq_id = ? ;";	
//				PreparedStatement statement = this.prepareStatement(query,
//						ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_READ_ONLY);
//				statement.setInt(1, userId);
...
//	}
//	/**
//	 * Return all default views created with the sequence id
//	 * @param sequenceId
//	 * @return
//	 */
//	public List<Integer> getDefaultInternViewsSequenceId(int sequenceId) {
//		List<Integer> ids = new ArrayList<Integer>();
//		if(this.databaseConnected()){
//			this.startQuery();
//			try {
...
//				"inner join internviewtoview as t3 on t1.id = t3.internview_id " +
//				"inner join views as t4 on t3.view_id = t4.id " +
//				"where t1.isdefault = true and t4.seq_id = ? ;";	
//				PreparedStatement statement = this.prepareStatement(query,
//						ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_READ_ONLY);
...
//	public boolean linkViewToInternView(String id, int defaultViewId) {
//		if(this.databaseConnected()){
//			this.startQuery();
//			try {
//				String query = "insert into internViewToView values (?,?) ;";
//				PreparedStatement statement = this.prepareStatement(query,
//						ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_READ_ONLY);
