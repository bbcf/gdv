...
echo "## copy scripts ..."
cp -r $HOME_PROJECT/$TMP_DIR/gdv/build_scripts/startDaemon.sh $HOME_PROJECT/bin/.
cp -r $HOME_PROJECT/$TMP_DIR/gdv/build_scripts/stopDaemon.sh $HOME_PROJECT/bin/.
cp -r $HOME_PROJECT/$TMP_DIR/gdv/build_scripts/hook.sh $HOME_PROJECT/bin/.
echo " execute hook ..."
#execute hook
